...
export async function sendConsoleAgentMessage({ apiBase, wallet, message, agentId = 'looper-demo', fetchImpl = fetch } = {}) {
  return requestConsoleJson({
    ...
    body: {
      ...
      agentId: String(agentId ?? 'looper-demo').trim() || 'looper-demo',
