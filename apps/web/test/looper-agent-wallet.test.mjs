...
test('wallet constants preserve current legacy account as read-only evidence only', () => {
  ...
  assert.equal(RELEASED_ACCOUNT_IMPLEMENTATION, '0xF038771904c6D3483cA85e3F1A755BB99995Bc04');
  assert.equal(RELEASED_ACCOUNT_RUNTIME_SHA256, '0x29c590647b1efbec0be899b8bb7768fa2f1f0773dafe5935ec1d61800f5005c4');
