...
test('dedicated Console route renders a human-facing operating surface for onchain agents', async () => {
  ...
  assert.match(consolePage.textContent, /Operator identity, mission memory, live signals, and review-only proposals/i);
  ...
  assert.equal(consolePage.querySelectorAll('.console-flow-panel li').length, 7);
